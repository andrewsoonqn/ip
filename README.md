...
Arnold provides a seamless interface to unlock everlasting memory. *Never forget a thing again.*
...
3. Launch the `help` command in the Arnold app interface to learn about what you can do with Arnold.
